<template>
  <div class="rawComponents">
    <nav style="display:flex;">
      <div :index="index + ''" v-for="(item, index) in iconArray" @click="onSelectElement(index)" :key="item.iconSrc" :class="{'active':currentIndex === index}" class="mainIconContainer">
    ...
    <nav>
      <div style="margin-bottom:10px;text-align:center;">
        ...
        <el-autocomplete class="inline-input" v-model="componentSearch" :fetch-suggestions="querySearch" size="small" placeholder="请输入..." @select="handleSelect"></el-autocomplete>
      </div>
