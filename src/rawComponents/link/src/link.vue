<template>
  <a :style="positionStyle" :href="propsCopy.disabled ? null : propsCopy.href" @click="transferStyleInfo(propsCopy.index)" draggable="true" @dragstart="dragStart($event)" @dragend="isViewOrComponent($event)" :class="[
      'lc-link',
