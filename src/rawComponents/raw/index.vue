<template lc_id="vSeYn6dQcE">
  <div lc_id="NahfEKxF68" class="demonstration-raw">
    <table border="0" lc_id="RDLbKPIVyp">
      ...
      <tr lc_id="bgvuIIHVqY">
        <td lc_id="h0nRibffcF">
          <div class="title" lc_id="MxMSt/pxUC">abbr（标记缩写）:</div>
        </td>
        <td lc_id="lX0P4NPEIk">
          <abbr lc-mark title="People's Republic of China" lc_id="oFoyJEu70y"
            >PRC</abbr
          >
        </td>
      </tr>
      <tr lc_id="inCzutb68I">
        ...
        <td lc_id="ylNI9kdThf">
          <article lc_id="p6pMF5D2hP">
            ...
            <p lc-mark lc_id="odzwtRzLYd">
              Windows Internet Explorer 9（简称 IE9）于 2011 年 3 月 14
              日发布.....
            </p>
          </article>
        </td>
      ...
      <tr lc_id="sQR/stqYia">
        ...
        <td lc_id="/RsZDrC6KZ">
          <aside lc-mark lc_id="65Oo0WGvvy">
