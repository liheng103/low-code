<template lc_id="GWGSFjvJGS">
  <div lc_id="mhJfF7mAeh">
    <div lc_id="OyEvjlhxKG">
      <div class="demonstration-element" lc_id="jS8CODuZ8w">
        Progress 进度条
      </div>
    ...
    <div lc_id="U4YG27qq4s">
      <div class="demonstration-element" lc_id="tI02wMGVyX">
        NavMenu 导航菜单
      </div>
      <el-menu
        lc-mark
        ...
        lc_id="ihtDhkfBO3"
      >
        <el-menu-item index="1" lc_id="VejVEahyRO"
        ...
        <el-sub-menu index="2" lc_id="b9dDZDEyzu">
          ...
          <el-sub-menu index="2-4" lc_id="kVYGkptqy3">
            ...
            <el-menu-item index="2-4-1" lc_id="KPPi+2aCzR"
              >item one</el-menu-item
            >
            <el-menu-item index="2-4-2" lc_id="9HsVuJIBXT"
              >item two</el-menu-item
            >
            <el-menu-item index="2-4-3" lc_id="pb1fYeVfpT"
    ...
    <div lc_id="Hr+gUUgFTD">
      ...
      <el-tabs
        ...
        lc_id="7TSxFc1h/T"
      >
        <el-tab-pane label="用户管理" name="first" lc_id="nESAhjJD5+"
          >用户管理</el-tab-pane
        >
        <el-tab-pane label="配置管理" name="second" lc_id="GS8HXVlmCM"
          >配置管理</el-tab-pane
        >
        <el-tab-pane label="角色管理" name="third" lc_id="/jr8Mrluge"
          >角色管理</el-tab-pane
        >
        <el-tab-pane label="定时任务补偿" name="fourth" lc_id="CYHnAsRUdX"
          >定时任务补偿</el-tab-pane
        >
      </el-tabs>
    </div>
    <div lc_id="0MpXv/hB5o">
      <div class="demonstration-element" lc_id="cXJHcFnFGI">
        Breadcrumb 面包屑
      </div>
      <el-breadcrumb separator="/" lc-mark lc_id="2kbMFsaBlw">
        <el-breadcrumb-item :to="{ path: '/' }" lc_id="Y24a1lsayw"
    ...
    <div lc_id="VliPzBWiIr">
      <div class="demonstration-element" lc_id="URE6411ToF">
        PageHeader 页头
      </div>
      <el-page-header
        lc-mark
    ...
    <div lc_id="q1K7UjfQRh">
      <div class="demonstration-element" lc_id="QRo+LiBcqY">
        Dropdown 下拉菜单
      </div>
      <el-dropdown lc-mark lc_id="eEugqtt2Ed">
        ...
        <template #dropdown lc_id="Jgi+BtUZkP">
          <el-dropdown-menu lc_id="fyNKB1+0hw">
            ...
            <el-dropdown-item disabled lc_id="590JIX3HSV"
              >双皮奶</el-dropdown-item
            >
            <el-dropdown-item divided lc_id="Svb2tOdBg/"
    ...
    <div lc_id="EduDP6YT5B">
      ...
      <el-card lc-mark class="box-card" lc_id="f7u3JZOXiY">
        <template #header lc_id="fcNx1E9u+l">
          ...
          <div v-for="o in 4" :key="o" class="text item" lc_id="WrqZOeR62/">
            {{ '列表内容 ' + o }}
          </div>
        </template>
      </el-card>
    ...
    <div lc_id="Ac3U6soq4v">
      <div class="demonstration-element" lc_id="yHQSJ5j0qr">
        Carousel 走马灯
      </div>
    ...
    <div lc_id="h98mxV67rm">
      <div class="demonstration-element" lc_id="YCdpR3F66X">
        Collapse 折叠面板
      </div>
      <el-collapse
        lc-mark
      ...
      >
        ...
        <el-collapse-item
          ...
          lc_id="POyL7FoSe4"
        >
          <div lc_id="DR+xM6f78t">
            用户决策：根据场景可给予用户操作建议或安全提示，但不能代替用户进行决策；
          </div>
          <div lc_id="2g+ldln/84">
    ...
    <div lc_id="0kee2BlFsA">
      <div class="demonstration-element" lc_id="0EBCjFbCyA">
        Timeline 时间线
      </div>
