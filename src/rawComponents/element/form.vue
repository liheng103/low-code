<template lc_id="03KSNQZ/MV">
  <div lc_id="JoW6e9bEi+">
      ...
      >
        ...
        >
          <el-button type="primary" size="small" lc_id="7ZjOmdz3Ur">
            上传
            <i class="el-icon-upload el-icon--right" lc_id="IOumsfqV0c"></i>
          </el-button>
        </el-form-item>
        <el-form-item
          label="自定义form-item"
        ...
        <el-form-item lc_id="wSyCEJYjUD">
          <el-button type="primary" @click="submitForm" lc_id="wp2oC1qxYN"
            >立即创建</el-button
          >
    ...
    <div lc_id="dyK4shOTgK">
      <div class="demonstration-element" lc_id="OPhwbT6T5C">
        Descriptions 描述列表
      </div>
      <el-descriptions title="用户信息" lc-mark lc_id="UcepzqrI8T">
        <el-descriptions-item label="用户名" lc-mark lc_id="61qM0Gdqq3"
          >kooriookami</el-descriptions-item
        >
        <el-descriptions-item label="手机号" lc_id="p9NL7l0+yS"
          >18100000000</el-descriptions-item
        >
        <el-descriptions-item label="居住地" lc_id="gA+SOSpqT1"
          >苏州市</el-descriptions-item
        >
        <el-descriptions-item label="备注" lc_id="MpLSTs1V1a">
          <el-tag size="small" lc_id="x+3JGPZLjM">学校</el-tag>
        </el-descriptions-item>
        <el-descriptions-item label="联系地址" lc_id="P7eacW7mxC"
      ...
      >
        >
        <el-descriptions-item label="用户名" lc_id="YTqOj5iy95"
          >kooriookami</el-descriptions-item
        >
        <el-descriptions-item label="手机号" lc_id="qx7ONklayE"
          >18100000000</el-descriptions-item
        >
        <el-descriptions-item label="居住地" :span="2" lc_id="Gip/4MIafd"
          >苏州市</el-descriptions-item
        >
        <el-descriptions-item label="备注" lc_id="4wYkIRcdbX">
          <el-tag size="small" lc_id="9iHUBLDbHY">学校</el-tag>
        </el-descriptions-item>
        <el-descriptions-item label="联系地址" lc_id="zfJtvesctl"
          >江苏省苏州市吴中区吴中大道 1188 号</el-descriptions-item
        >
      </el-descriptions>
    </div>
