<template lc_id="h951btrjIz">
  <div lc_id="Wys3+gAG6o">
    <div lc_id="xz+q4JsE0H">
      <div class="demonstration-element" lc_id="QOAgJcuNgl">
        Button 默认按钮
      </div>
    ...
    <div lc_id="aS+4+fs63u">
      <div class="demonstration-element" lc_id="eZqzsVXDsz">
        Button 朴素按钮
      </div>
      <el-button lc-mark plain lc_id="BC7OoDacJj">朴素按钮</el-button>
      <el-button lc-mark type="primary" plain lc_id="bWC9CeWjjY"
        >主要按钮</el-button
      >
      <el-button lc-mark type="success" plain lc_id="sVBJspZDuU"
        >成功按钮</el-button
      >
      <el-button lc-mark type="info" plain lc_id="YUbh6jGrjF"
        >信息按钮</el-button
      >
      <el-button lc-mark type="warning" plain lc_id="LOykTx4Sf0"
        >警告按钮</el-button
      >
      <el-button lc-mark type="danger" plain lc_id="0hBjU/hwbY"
        >危险按钮</el-button
      >
    </div>
    <div lc_id="TIyAo1YWH2">
      <div class="demonstration-element" lc_id="ci4hr/TXbi">
        Button 圆角按钮
      </div>
      <el-button lc-mark round lc_id="JGOxzRnIcl">圆角按钮</el-button>
      <el-button lc-mark type="primary" round lc_id="GOolXgPQ8i"
        >主要按钮</el-button
      >
      <el-button lc-mark type="success" round lc_id="QpK7RbxSP1"
        >成功按钮</el-button
      >
      <el-button lc-mark type="info" round lc_id="rPNRcyrUBY"
        >信息按钮</el-button
      >
      <el-button lc-mark type="warning" round lc_id="MCBR6sxh+2"
        >警告按钮</el-button
      >
      <el-button lc-mark type="danger" round lc_id="KCAVqthQwo"
        >危险按钮</el-button
      >
    </div>
    <div lc_id="RdvVbD8tRt">
      <div class="demonstration-element" lc_id="MCe1tz7lec">
        Button 文字按钮
      </div>
      <el-button lc-mark type="text" lc_id="VzeBeEyMRU">文字按钮</el-button>
      <el-button lc-mark type="text" disabled lc_id="gGBAHuLrE2"
        >文字按钮</el-button
      >
    </div>
