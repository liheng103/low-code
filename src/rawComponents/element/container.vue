<template lc_id="pF5ZSBfZwR">
  <div lc_id="svh5gymRbT">
    <div lc_id="aklN6TcgSi">
      <div class="demonstration-element" lc_id="H9Bt++Jp23">
        Container 布局容器
      </div>
    ...
    <div lc_id="Lg787FEsDw">
      <div class="demonstration-element" lc_id="jlEgJZCE+i">
        Skeleton 骨架屏
      </div>
        ...
        <el-col :sm="12" :lg="6" lc_id="deKtOM/g2K">
          ...
          >
            <template #extra lc_id="iJQp/8XeSP">
              <el-button type="primary" size="medium" lc_id="UCFmR9EP+q"
                >返回</el-button
              >
            </template>
          </el-result>
        ...
        <el-col :sm="12" :lg="6" lc_id="1smWMRRuZr">
          ...
          >
            <template #extra lc_id="c6Unj7eQIv">
              <el-button type="primary" size="medium" lc_id="MDEtfbmEZd"
                >返回</el-button
              >
            </template>
          </el-result>
        ...
        <el-col :sm="12" :lg="6" lc_id="2zio5J9ljq">
          ...
          >
            <template #extra lc_id="rnIhJqKRjQ">
              <el-button type="primary" size="medium" lc_id="MhrCBFBHlN"
                >返回</el-button
              >
            </template>
          </el-result>
        ...
        <el-col :sm="12" :lg="6" lc_id="h7xNXozZ0s">
          ...
          >
            <template #extra lc_id="nHgp3LGSea">
              <el-button type="primary" size="medium" lc_id="VURe3Zlhq0"
                >返回</el-button
              >
            </template>
          </el-result>
