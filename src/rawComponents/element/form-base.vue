<template lc_id="6qRH3lc1dt">
  <div lc_id="nqlS2COw0N">
    ...
    <div lc_id="wwgDyr1OR2">
      <div class="demonstration-element" lc_id="6KW/uZOTEM">
        Checkbox 多选框
      </div>
    ...
    <div lc_id="4JbZ+JNrQw">
      <div class="demonstration-element" lc_id="qBSKct8boj">
        InputNumber 计数器
      </div>
      <div
    ...
    <div lc_id="nDNR0MoKZA">
      <div class="demonstration-element" lc_id="p4yqbL8QdC">
        Cascader 级联选择器
      </div>
      <el-cascader
        lc-mark
    ...
    <div lc_id="5dyMzD3j06">
      <div class="demonstration-element" lc_id="ERiurnsreT">
        TimePicker 时间选择器
      </div>
      <el-time-select
        v-model="value5"
    ...
    <div lc_id="xWW1lIgrLe">
      <div class="demonstration-element" lc_id="Sm6zFTno79">
        DatePicker 日期选择器
      </div>
      <el-date-picker
        v-model="value6"
    ...
    <div lc_id="SFEe1Ua3f3">
      ...
      <div lc_id="Cco/MVefy1">
        <el-upload
          ...
          lc_id="7frE/pSrYE"
        >
          <el-button size="small" type="primary" lc_id="c/5KHeT+LU"
            >点击上传</el-button
          >
          <template #tip lc_id="cEzrM0eEXc">
            <div class="el-upload__tip" lc_id="Vh2iLMvT2c">
      ...
      <div lc-mark style="max-width: 400px; font-size: 12px" lc_id="NwHRrU2JEM">
        ...
        <el-upload
          ...
          lc_id="+hJ7DSkPgT"
        >
          <el-button size="small" type="primary" lc_id="y3uZKsl9b/"
            >点击上传</el-button
          >
          <template #tip lc_id="0JB5ZbGk3I">
            <div class="el-upload__tip" lc_id="esyAhLLNGI">
              只能上传jpg/png文件，且不超过500kb
            </div>
          </template>
        </el-upload>
      ...
      <div lc_id="g/E9ZNwP9E">
        ...
        >
          ...
          <template #tip lc_id="K65M529P0Z">
            <div class="el-upload__tip" lc_id="4GA0T+3HDL">
              只能上传jpg/png文件，且不超过500kb
            </div>
          </template>
        </el-upload>
    ...
    <div lc_id="unZHE/lFYS">
      <div class="demonstration-element" lc_id="9gDxl8XOEm">
        ColorPicker 颜色选择器
      </div>
      <el-color-picker
        lc-mark
